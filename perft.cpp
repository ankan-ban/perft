...
// 0 - use 088 move generation
// 1 - use look up table for generating sliding pice moves
#define LUT_MOVE_GENERATION 0
...
#if LUT_MOVE_GENERATION == 1
    uint32 nMoves = MoveGeneratorLUT::generateMoves(pos, moves);
#else
